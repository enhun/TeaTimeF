...
namespace TeaTimeDemo.DataAccess.Migrations
{
    ...
    [Migration("20250318075415_dbcontext")]
            ...
            modelBuilder.Entity("TeaTimeDemo.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            Description = "濃縮紅牛、濃縮咖啡、濃縮可樂加上鹽巴，保證讓血壓直衝雲霄！",
                            DisplayOrder = 0,
                            ImageUrl = "",
                            Name = "高血壓特調",
                            Price = 99.0,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 5,
                            Description = "純奶油、全脂牛奶、蛋黃、起司、炸培根混合而成，喝一口就像體檢報告爆表的感覺。",
                            DisplayOrder = 0,
                            ImageUrl = "",
                            Name = "膽固醇奶昔",
                            Price = 120.0,
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 6,
                            Description = "超高糖、超高鹽、超高油，奶蓋厚到可以當被子蓋，珍珠浸泡在煉乳中，糖度100%起跳！",
                            DisplayOrder = 0,
                            ImageUrl = "",
                            Name = "三高手搖茶",
                            Price = 85.0,
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 7,
                            Description = "新鮮羽衣甘藍、菠菜、酪梨、奇亞籽與燕麥奶混合，讓你的心跳穩定如心電圖。",
                            DisplayOrder = 0,
                            ImageUrl = "",
                            Name = "心電圖綠拿鐵",
                            Price = 80.0,
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 8,
                            Description = "枸杞、紅棗、決明子與菊花泡製，專為熬夜加班族打造，讓肝臟回春！",
                            DisplayOrder = 0,
                            ImageUrl = "",
                            Name = "護肝好茶",
                            Price = 65.0,
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 9,
                            Description = "燕窩、純牛奶、龍眼蜜，補充滿滿膠原蛋白，喝了讓皮膚發光，醫護人員最愛！",
                            DisplayOrder = 0,
                            ImageUrl = "",
                            Name = "白袍燕窩牛奶",
                            Price = 150.0,
