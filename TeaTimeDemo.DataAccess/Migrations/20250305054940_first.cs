    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "台北市信義區", "台北市", "濃厚的教育文化及熱鬧繁華的商圈，豐富整體氛圍。", "台北店", "0911111111" },
                    { 2, "台中市西區", "台中市", "鄰近台中一中商圈，,學生消暑勝地。", "台中店", "0987654321" },
                    { 3, "台南安平區", "台南市", "歷史造就了現今的安平，茶香中蘊含了悠遠的歷史。", "台南店", "0988888888" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "天然果飲，迷人多變", 0, "", "台灣水果茶", 60.0, "大杯", 0 },
                    { 2, 2, "品鐵觀音，享人生的味道", 0, "", "鐵觀音", 35.0, "中杯", 0 },
                    { 3, 3, "用咖啡體悟休閒時光", 0, "", "美式咖啡", 50.0, "中杯", 0 }
                });
